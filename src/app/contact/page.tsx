    ...
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 py-12 pt-36 relative">
      ...
      <div className="max-w-2xl mx-auto p-4 relative z-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 mt-4">
          ...
          <button
            type="submit"
            className="px-6 py-2 rounded-lg bg-gradient-to-r from-[#00ccb1] via-[#ad9dfd] to-[#e4a8f3] hover:from-[#8cfced] hover:via-[#937eff] hover:to-[#e374ff] transition duration-200 font-medium focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2 hover:scale-105"
          >
            Send Message
          </button>
        </form>
